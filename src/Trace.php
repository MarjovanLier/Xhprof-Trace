...
final class Trace
{
     ...
     *
     * @param array $item The performance metrics for the function, including 'ct', 'wt', 'cpu', 'mu', 'pmu', and
     *     'name'.
     ...
     * @param mixed $previousMetricValue The metric value of the previous function in the ranking, or null for the
     *     first function.
     *
     * @return array{int, int, mixed} An array containing the updated rank, the updated count of consecutive functions
     *     with the same metric value, and the metric value of the current function. metric value.
     */
